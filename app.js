...
//Question 3
// var fnum = +prompt("Enter a Number");

// if(fnum>0) {
//     alert("Your number is positive" + " " + fnum);
// }

// else if(0>fnum) {
//     alert("Your number is negative" + " " + fnum);
// }
...
//Question 5
// var correctPass="jazib", userPass;
// var userPass= (prompt("Enter Your Password"));
// if (userPass==""){
//     alert("Please enter your password");
// }
// else if (correctPass==userPass){
//     prompt("Kindly enter your password again");
